...
adw_flap_demo_window_class_init (AdwFlapDemoWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/Adwaitamm1/Demo/ui/pages/flap/adw-flap-demo-window.ui");
...
{
  return ADW_FLAP_DEMO_WINDOW(g_object_new (ADW_TYPE_FLAP_DEMO_WINDOW, NULL));
}
