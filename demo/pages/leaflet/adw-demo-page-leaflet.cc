                                    ...
                                    GParamSpec   *pspec)
{
  ...
  switch (prop_id) {
  case PROP_TRANSITION_TYPE:
    self->transition_type = static_cast<AdwLeafletTransitionType>(g_value_get_enum (value));
    break;
  default:
    G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
  }
...
adw_demo_page_leaflet_class_init (AdwDemoPageLeafletClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/Adwaitamm1/Demo/ui/pages/leaflet/adw-demo-page-leaflet.ui");
