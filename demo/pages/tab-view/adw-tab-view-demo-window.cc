          ...
          GIcon                *icon)
{
  ...
  content = GTK_WIDGET(g_object_new (GTK_TYPE_ENTRY,
                          "text", title,
...
adw_tab_view_demo_window_class_init (AdwTabViewDemoWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/Adwaitamm1/Demo/ui/pages/tab-view/adw-tab-view-demo-window.ui");
...
{
  return ADW_TAB_VIEW_DEMO_WINDOW(g_object_new (ADW_TYPE_TAB_VIEW_DEMO_WINDOW, NULL));
}
