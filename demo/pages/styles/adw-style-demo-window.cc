...
adw_style_demo_window_class_init (AdwStyleDemoWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/Adwaitamm1/Demo/ui/pages/styles/adw-style-demo-window.ui");
...
{
  return ADW_STYLE_DEMO_WINDOW(g_object_new (ADW_TYPE_STYLE_DEMO_WINDOW, NULL));
}
