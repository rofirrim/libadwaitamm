...
adw_demo_window_class_init (AdwDemoWindowClass *klass)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/Adwaitamm1/Demo/ui/adw-demo-window.ui");
...
{
  return ADW_DEMO_WINDOW(g_object_new (ADW_TYPE_DEMO_WINDOW, "application", application, NULL));
}
