...
namespace Adw {
/** %Adw::SelectionListModelImpl is an object that implements the Gio::ListModel
 ...
 * in a %Adw::SelectionListModelImpl object. %Adw::SelectionListModelImpl does
 * not directly correspond to any GTK class.
 *
